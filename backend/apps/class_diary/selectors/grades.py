...
def get_grades_for_user(*, user, student_id=None, enrollment_id=None):
    """Notas visíveis para o usuário, conforme escopo RBAC."""
    qs = Grade.objects.filter(is_active=True).select_related(
        'enrollment',
        'enrollment__student',
        'subject',
        'academic_period',
